...
class LoginActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnLogin.setOnClickListener {
            ...
            //check data
            val data:String = databaseHelper.checkData("pamela@students.amikom.ac.id")
            Toast.makeText(this@LoginActivity, "Result : " + data,
                    Toast.LENGTH_SHORT).show()
            if (data == null){
                //insert data
                databaseHelper.addAccount("pamela@students.amikom.ac.id",
                    "Pamela Riva Adina", "Cashier", "12345")
            }
